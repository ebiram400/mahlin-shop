                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="product-details-affiliate.html">
                                                                <span class="mm-text">محصولات وابسته</span>
                                                            </a>
                                                        </li>                                                    
                                                        <li>
                                                            <a href="product-details-variable.php">
                                                                <span class="mm-text"> تغییر محصول</span>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a href="product-details-group.php">
                                                                <span class="mm-text">گروه محصولات</span>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li>
                                                    <a href="order-tracking.html">
                                                        <span class="mm-text">کد پیگیری سفارش</span>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="wishlist.php">
                                                        <span class="mm-text">لیست علاقه مندی</span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <ul class="header-toolbar">
                                ...
                                <li class="header-toolbar__item user-info">
                                    ...
                                    <ul class="user-info-menu">
                                        ...
                                        <li>
                                            <a href="wishlist.php">لیست علاقه مندی</a>
                                        </li>
                                        <li>
                                            <a href="order-tracking.php">سفارش پست</a>
                                        </li>
                                        <li>
                                            <a href="compare.php">مقایسه</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="header-toolbar__item">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
                            <h1 class="page-title">چک کردن</h1>
                            <ul class="breadcrumb">
                                <li><a href="index.php">صفحه اصلی</a></li>
                                <li class="current"><span>چک کردن</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="user-actions user-actions__coupon">
                                <div class="message-box mb--30">
                                    <p><i class="fa fa-exclamation-circle"></i>کد تخفیف دارید? <a class="expand-btn" href="#coupon_info">Click Here To Enter Your Code.</a></p>
                                </div>
                                <div id="coupon_info" class="user-actions__form hide-in-default">
                                    <form action="#" class="form">
                                        <p>اگر کد تخفیف دارید اینحا وارد کنید</p>
