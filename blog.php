                            ...
                            <ul class="header-toolbar">
                                ...
                                <li class="header-toolbar__item user-info">
                                    ...
                                    <ul class="user-info-menu">
                                        <li>
                                            <a href="my-account.html">ورود/عضویت</a>
                                        </li>
                                        <li>
                                            <a href="cart.html">صورتحساب من</a>
                                        </li>
                                        <li>
                                            <a href="checkout.html">مشخصات خریدار</a>
                                        </li>
                                        <li>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
                            ...
                            <ul class="breadcrumb" dir="ltr">
                                <li class="current"><span>بلاگ</span></li>
                            ...
                            <div class="single-post">
                                ...
                                <article class="single-post-details">
                                    ...
                                    <div class="entry-media">
                                        <div class="image">
                                            <img src="assets/img/blog/blog_detail_1.jpg" alt="Post Thumbnail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="nav-links">
                                        <div class="nav-prev nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="assets/img/blog/blog-13-100x100.jpg" alt="Prev Post">
                                            </div>
                                        ...
                                        <div class="nav-next nav-links__inner">
                                            ...
                                            <div class="nav-links__thumb">
                                                <img src="assets/img/blog/blog-3-100x100.jpg" alt="Next Post">
                                            </div>
                                            <div class="nav-links__content">
