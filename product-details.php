<!doctype html>
<html  class="no-js"><!--------Theme Shered by Mellatweb(مرجع رسمی خرید و فروش قالب و انتشار قالب های پولی)--------->
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="product-details-variable.php">
                            ...
                            <ul class="header-toolbar">
                                ...
                                <li class="header-toolbar__item user-info">
                                    ...
                                    <ul class="user-info-menu">
                                        ...
                                        <li>
                                            <a href="checkout.php">چک کردن</a>
                                        </li>
                                        <li>
                                            <a href="wishlist.php">لیست علاقه مندی ها</a>
                                        </li>
                                        <li>
                    ...
                    <div class="col-12">
                        <div class="d-flex justify-content-between align-items-center flex-sm-row flex-column">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="current"><span> جزییات محصول</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
                                            ...
                                            <table class="table shop_attributes">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th>رنگ</th>
                                                        <td>
                                                            <a href="shop-sidebar.php">مشکی</a>,
                                                            <a href="shop-sidebar.php">خاکستری</a>,
                                                            <a href="shop-sidebar.php">قرمز</a>,
                                                            <a href="shop-sidebar.php">بنفش</a>,
                                                            <a href="shop-sidebar.php">زرد</a>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <a href="product-details.php">
                                                    <img src="assets/img/products/prod-9.jpg" alt="Products">
                                                </a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <a href="cart.php" class="btn btn-small btn-bg-sand btn-color-dark">Add To Cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="zakas-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <a href="product-details.php">
                                                    <img src="assets/img/products/prod-10.jpg" alt="Products">
                                                </a>
                                                <div class="zakas-product-action">
                                                    <div class="product-action d-flex">
                                                        <div class="product-size">
                                            ...
                                            <div class="product-info">
                                                <h3 class="product-title mb--15">
                                                    <a href="product-details.php">تاپ بلند</a>
                                                </h3>
                                                <div class="product-price-wrapper mb--30">
                                                ...
                                                <a href="cart.php" class="btn btn-small btn-bg-sand btn-color-dark">اضافه کردن به علاقه مندی</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="zakas-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <a href="product-details.php">
                                                    <img src="assets/img/products/prod-11.jpg" alt="Products">
                                                </a>
                                                <div class="zakas-product-action">
                                                    <div class="product-action d-flex">
                                                        <div class="product-size">
                                ...
                                <div class="item">
                                    <div class="zakas-product">
                                        <div class="product-inner">
                                            <figure class="product-image">
                                                <a href="product-details.php">
                                                    <img src="assets/img/products/prod-12.jpg" alt="Products">
                                                </a>
                                                <div class="zakas-product-action">
                                                    <div class="product-action d-flex">
                                                        <div class="product-size">
                ...
                <div class="mini-cart-inner">
                    ...
                    <div class="mini-cart__content">
                        ...
                        <div class="mini-cart__buttons">
                            <a href="cart.php" class="btn btn-fullwidth btn-bg-sand mb--20">نمایش علاقه مندی</a>
